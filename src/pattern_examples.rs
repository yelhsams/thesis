...
mod tests {
    ...
    fn test_arithmetic_isle_rules() {
        ...
        // 1. ineg(x) => sub(0, x)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, neg_x, Opcode::Sub),
        ...
        // 2. sub(0, x) => ineg(x)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, sub0x, Opcode::Ineg),
        ...
        // 3. add(x, ineg(y)) => sub(x, y)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, add_neg, Opcode::Sub),
        ...
        // 4. sub(add(x, y), y) => x
        {
            ...
            assert!(
                rewrites_to_value(&mut dfg, sub_y, x),
        ...
        // 5. mul(x, 4) => shl(x, 2)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, mul4, Opcode::Shl),
        ...
        // 6. sdiv(x, 1) => x
        {
            ...
            assert!(
                rewrites_to_value(&mut dfg, sdiv1, x),
        ...
        // 7. urem(x, 1) => 0
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, urem1, 0),
        ...
        // 8. select(1, x, y) => x
        {
            ...
            assert!(
                rewrites_to_value(&mut dfg, sel, x),
        ...
        // 9. select(0, x, y) => y
        {
            ...
            assert!(
                rewrites_to_value(&mut dfg, sel, y),
        ...
        // 10. bnot(x) + 1 => ineg(x)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, add1, Opcode::Ineg),
    ...
    fn test_const_fold_isle() {
        ...
        // 1. add(5, 3) => 8
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, add, 8),
        ...
        // 2. sub(10, 4) => 6
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, sub, 6),
        ...
        // 3. mul(6, 7) => 42
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, mul, 42),
        ...
        // 4. and(0xFF, 0x0F) => 0x0F
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, and, 0x0F),
        ...
        // 5. or(0xF0, 0x0F) => 0xFF
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, or, 0xFF),
        ...
        // 6. xor(0xFF, 0x0F) => 0xF0
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, xor, 0xF0),
        ...
        // 7. shl(1, 3) => 8
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, shl, 8),
        ...
        // 8. ineg(5) => -5
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, neg, -5),
        ...
        // 9. bnot(0) => -1
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, bnot, -1),
        ...
        // 10. iabs(-7) => 7
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, abs, 7),
        ...
        // 11. eq(5, 5) => 1
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, eq, 1),
        ...
        // 12. slt(3, 5) => 1
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, slt, 1),
        ...
        // 13. clz(0) => 64
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, clz, 64),
        ...
        // 14. ctz(8) => 3
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, ctz, 3),
    ...
    fn test_icmp_isle_rules() {
        ...
        // 1. ult(x, 0) => 0
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, ult0, 0),
        ...
        // 2. uge(x, 0) => 1
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, uge0, 1),
        ...
        // 3. eq(eq(x, y), 0) => ne(x, y)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, eq0, Opcode::Ne),
        ...
        // 4. ne(eq(x, y), 0) => eq(x, y)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, ne0, Opcode::Eq),
        ...
        // 5. eq(bnot(x), bnot(y)) => eq(x, y)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, eq_bb, Opcode::Eq),
        ...
        // 6. eq(add(x, c), add(y, c)) => eq(x, y)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, eq_add, Opcode::Eq),
        ...
        // 7. ule(0, x) => 1
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, ule, 1),
        ...
        // 8. ugt(0, x) => 0
        {
            ...
            assert!(
                rewrites_to_const(&mut dfg, ugt, 0),
    ...
    fn test_extend_isle_rules() {
        ...
        // 1. uextend(uextend(x)) => uextend(x)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, ext2, Opcode::Uextend),
        ...
        // 2. sextend(sextend(x)) => sextend(x)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, ext2, Opcode::Sextend),
        ...
        // 3. ireduce(ireduce(x)) => ireduce(x)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, red2, Opcode::Ireduce),
        ...
        // 4. ireduce(uextend(x)) => x
        {
            ...
            assert!(
                rewrites_to_value(&mut dfg, red, x),
        ...
        // 6. and(uextend(x), uextend(y)) => uextend(and(x, y))
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, and, Opcode::Uextend),
        ...
        // 7. eq(uextend(x), uextend(y)) => eq(x, y)
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, eq, Opcode::Eq),
        ...
        // 8. ineg(sextend(x)) => sextend(ineg(x))
        {
            ...
            assert!(
                rewrites_to_opcode(&mut dfg, neg, Opcode::Sextend),
