        ...
        match pattern {
            ...
            Pattern::AnyConstant(var) => {
                ...
                let const_val = if var.0 == "result" {
                    ...
                    bindings.get_constant(&result_key).or_else(|| bindings.get_constant(var))
                };
    ...
    pub fn standard() -> Self {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            unsafe {
                                ...
                                (*bp).constants.insert(VarId::new("result"), a.wrapping_add(b));
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("ineg-to-sub")
                ...
                .produce(Pattern::op(Opcode::Sub, vec![Pattern::constant(0), Pattern::var("x")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("sub-zero-to-ineg")
                .match_pattern(Pattern::op(Opcode::Sub, vec![Pattern::constant(0), Pattern::var("x")]))
        ...
        rules.push(
            Rewrite::new("iabs-ineg")
                .match_pattern(Pattern::op(Opcode::Iabs, vec![
        ...
        rules.push(
            Rewrite::new("iabs-iabs")
                .match_pattern(Pattern::op(Opcode::Iabs, vec![
                    Pattern::op(Opcode::Iabs, vec![Pattern::var("x")]),
                ]))
                .produce(Pattern::op(Opcode::Iabs, vec![Pattern::var("x")]))
                .build(),
        );
        ...
        for (pow, shift) in [(4i64, 2i64), (8, 3), (16, 4), (32, 5), (64, 6)] {
            rules.push(
                Rewrite::new(format!("mul-pow2-{}", pow))
                    .match_pattern(Pattern::op(Opcode::Mul, vec![Pattern::var("x"), Pattern::constant(pow)]))
                    .produce(Pattern::op(Opcode::Shl, vec![Pattern::var("x"), Pattern::constant(shift)]))
                    .build(),
            );
        }
        ...
        rules.push(
            Rewrite::new("add-self-to-shl")
                .match_pattern(Pattern::op(Opcode::Add, vec![Pattern::var("x"), Pattern::var("x")]))
                .produce(Pattern::op(Opcode::Shl, vec![Pattern::var("x"), Pattern::constant(1)]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("add-ineg-to-sub")
                .match_pattern(Pattern::op(Opcode::Add, vec![
                    Pattern::var("x"),
                    Pattern::op(Opcode::Ineg, vec![Pattern::var("y")]),
                ]))
                .produce(Pattern::op(Opcode::Sub, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("sub-ineg-to-add")
                .match_pattern(Pattern::op(Opcode::Sub, vec![
                    Pattern::var("x"),
                    Pattern::op(Opcode::Ineg, vec![Pattern::var("y")]),
                ]))
                .produce(Pattern::op(Opcode::Add, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("sdiv-one")
                .match_pattern(Pattern::op(Opcode::Sdiv, vec![Pattern::var("x"), Pattern::constant(1)]))
                .produce(Pattern::var("x"))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("udiv-one")
                .match_pattern(Pattern::op(Opcode::Udiv, vec![Pattern::var("x"), Pattern::constant(1)]))
                .produce(Pattern::var("x"))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("urem-one")
                .match_pattern(Pattern::op(Opcode::Urem, vec![Pattern::var("x"), Pattern::constant(1)]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("srem-one")
                .match_pattern(Pattern::op(Opcode::Srem, vec![Pattern::var("x"), Pattern::constant(1)]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("sdiv-zero-num")
                .match_pattern(Pattern::op(Opcode::Sdiv, vec![Pattern::constant(0), Pattern::var("x")]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("udiv-zero-num")
                .match_pattern(Pattern::op(Opcode::Udiv, vec![Pattern::constant(0), Pattern::var("x")]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("srem-zero-num")
                .match_pattern(Pattern::op(Opcode::Srem, vec![Pattern::constant(0), Pattern::var("x")]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("urem-zero-num")
                .match_pattern(Pattern::op(Opcode::Urem, vec![Pattern::constant(0), Pattern::var("x")]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("select-true")
                .match_pattern(Pattern::op(Opcode::Select, vec![
                    Pattern::constant(1), Pattern::var("x"), Pattern::var("y"),
                ]))
                .produce(Pattern::var("x"))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("select-false")
                .match_pattern(Pattern::op(Opcode::Select, vec![
                    Pattern::constant(0), Pattern::var("x"), Pattern::var("y"),
                ]))
                .produce(Pattern::var("y"))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("select-same")
                .match_pattern(Pattern::op(Opcode::Select, vec![
                    Pattern::var("c"), Pattern::var("x"), Pattern::var("x"),
                ]))
                .produce(Pattern::var("x"))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("xor-neg1-to-bnot")
                .match_pattern(Pattern::op(Opcode::Xor, vec![Pattern::var("x"), Pattern::constant(-1)]))
        ...
        rules.push(
            Rewrite::new("bnot-to-xor-neg1")
                ...
                .produce(Pattern::op(Opcode::Xor, vec![Pattern::var("x"), Pattern::constant(-1)]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("xor-bnot-all-ones")
                .match_pattern(Pattern::op(Opcode::Xor, vec![
                    Pattern::var("x"),
                    Pattern::op(Opcode::Bnot, vec![Pattern::var("x")]),
                ]))
                .produce(Pattern::constant(-1))
        ...
        rules.push(
            Rewrite::new("and-xor-to-or")
                ...
                .produce(Pattern::op(Opcode::Or, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("or-xor-to-and")
                ...
                .produce(Pattern::op(Opcode::And, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("demorgan-and")
                .match_pattern(Pattern::op(Opcode::Bnot, vec![
                    Pattern::op(Opcode::And, vec![Pattern::var("x"), Pattern::var("y")]),
                ]))
                .produce(Pattern::op(Opcode::Or, vec![
                    Pattern::op(Opcode::Bnot, vec![Pattern::var("x")]),
        ...
        rules.push(
            Rewrite::new("rotl-zero")
                .match_pattern(Pattern::op(Opcode::Rotl, vec![Pattern::var("x"), Pattern::constant(0)]))
                .produce(Pattern::var("x"))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("rotr-zero")
                .match_pattern(Pattern::op(Opcode::Rotr, vec![Pattern::var("x"), Pattern::constant(0)]))
                .produce(Pattern::var("x"))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("const-fold-sub")
                .match_pattern(Pattern::op(Opcode::Sub, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), a.wrapping_sub(b));
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("const-fold-mul")
                .match_pattern(Pattern::op(Opcode::Mul, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), a.wrapping_mul(b));
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("const-fold-shl")
                .match_pattern(Pattern::op(Opcode::Shl, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            if b >= 0 && b < 64 {
                                unsafe {
                                    let bp = bindings as *const Bindings as *mut Bindings;
                                    (*bp).constants.insert(VarId::new("result"), a.wrapping_shl(b as u32));
                                }
                                true
                            } else {
                                false
        ...
        rules.push(
            Rewrite::new("const-fold-ushr")
                .match_pattern(Pattern::op(Opcode::Ushr, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            if b >= 0 && b < 64 {
                                unsafe {
                                    let bp = bindings as *const Bindings as *mut Bindings;
                                    (*bp).constants.insert(VarId::new("result"), ((a as u64).wrapping_shr(b as u32)) as i64);
                                }
                                true
                            } else {
                                false
        ...
        rules.push(
            Rewrite::new("const-fold-sshr")
                .match_pattern(Pattern::op(Opcode::Sshr, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            if b >= 0 && b < 64 {
                                unsafe {
                                    let bp = bindings as *const Bindings as *mut Bindings;
                                    (*bp).constants.insert(VarId::new("result"), a.wrapping_shr(b as u32));
                                }
                                true
                            } else {
                                false
                ...
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let Some(a) = bindings.get_constant(&VarId::new("a")) {
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), a.wrapping_neg());
                            }
                            true
                        } else {
                            false
                ...
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let Some(a) = bindings.get_constant(&VarId::new("a")) {
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), a.wrapping_abs());
                            }
                            true
                        } else {
                            false
                ...
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let Some(a) = bindings.get_constant(&VarId::new("a")) {
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), (a as u64).leading_zeros() as i64);
                            }
                            true
                        } else {
                            false
                ...
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let Some(a) = bindings.get_constant(&VarId::new("a")) {
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), (a as u64).trailing_zeros() as i64);
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("const-fold-rotl")
                .match_pattern(Pattern::op(Opcode::Rotl, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), (a as u64).rotate_left((b & 63) as u32) as i64);
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("const-fold-rotr")
                .match_pattern(Pattern::op(Opcode::Rotr, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), (a as u64).rotate_right((b & 63) as u32) as i64);
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("const-fold-eq")
                .match_pattern(Pattern::op(Opcode::Eq, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(a), Some(b)) = (
                            ...
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), if a == b { 1 } else { 0 });
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("const-fold-ne")
                .match_pattern(Pattern::op(Opcode::Ne, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
        ...
        rules.push(
            Rewrite::new("const-fold-slt")
                .match_pattern(Pattern::op(Opcode::Slt, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
        ...
        rules.push(
            Rewrite::new("const-fold-sle")
                .match_pattern(Pattern::op(Opcode::Sle, vec![
                    Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
        ...
        rules.push(
            Rewrite::new("const-fold-select")
                .match_pattern(Pattern::op(Opcode::Select, vec![
                    Pattern::any_constant("c"), Pattern::any_constant("a"), Pattern::any_constant("b"),
                ]))
                .produce(Pattern::any_constant("result"))
                .when(Condition::Custom {
                    ...
                    check: |bindings| {
                        if let (Some(c), Some(a), Some(b)) = (
                            ...
                            unsafe {
                                let bp = bindings as *const Bindings as *mut Bindings;
                                (*bp).constants.insert(VarId::new("result"), if c != 0 { a } else { b });
                            }
                            true
                        } else {
                            false
        ...
        rules.push(
            Rewrite::new("ult-zero-false")
                .match_pattern(Pattern::op(Opcode::Ult, vec![Pattern::var("x"), Pattern::constant(0)]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("uge-zero-true")
                .match_pattern(Pattern::op(Opcode::Uge, vec![Pattern::var("x"), Pattern::constant(0)]))
                .produce(Pattern::constant(1))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("ule-zero-left-true")
                .match_pattern(Pattern::op(Opcode::Ule, vec![Pattern::constant(0), Pattern::var("x")]))
                .produce(Pattern::constant(1))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("ugt-zero-left-false")
                .match_pattern(Pattern::op(Opcode::Ugt, vec![Pattern::constant(0), Pattern::var("x")]))
                .produce(Pattern::constant(0))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("ne-eq-zero")
                ...
                .produce(Pattern::op(Opcode::Eq, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("eq-eq-zero-to-ne")
                ...
                .produce(Pattern::op(Opcode::Ne, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("slt-ineg-ineg")
                ...
                .produce(Pattern::op(Opcode::Slt, vec![Pattern::var("y"), Pattern::var("x")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("sle-ineg-ineg")
                ...
                .produce(Pattern::op(Opcode::Sle, vec![Pattern::var("y"), Pattern::var("x")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("slt-add-cancel")
                ...
                .produce(Pattern::op(Opcode::Slt, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("uextend-uextend")
                .match_pattern(Pattern::op(Opcode::Uextend, vec![
        ...
        rules.push(
            Rewrite::new("sextend-sextend")
                .match_pattern(Pattern::op(Opcode::Sextend, vec![
        ...
        rules.push(
            Rewrite::new("ireduce-ireduce")
                .match_pattern(Pattern::op(Opcode::Ireduce, vec![
                    Pattern::op(Opcode::Ireduce, vec![Pattern::var("x")]),
                ]))
        ...
        rules.push(
            Rewrite::new("and-uextend")
                ...
                .produce(Pattern::op(Opcode::Uextend, vec![
                    Pattern::op(Opcode::And, vec![Pattern::var("x"), Pattern::var("y")]),
                ]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("ineg-sextend")
                .match_pattern(Pattern::op(Opcode::Ineg, vec![
                    Pattern::op(Opcode::Sextend, vec![Pattern::var("x")]),
                ]))
                .produce(Pattern::op(Opcode::Sextend, vec![
                    Pattern::op(Opcode::Ineg, vec![Pattern::var("x")]),
                ]))
                .build(),
        );
        ...
        rules.push(
            Rewrite::new("ult-uextend-uextend")
                .match_pattern(Pattern::op(Opcode::Ult, vec![
                    Pattern::op(Opcode::Uextend, vec![Pattern::var("x")]),
                    Pattern::op(Opcode::Uextend, vec![Pattern::var("y")]),
                ]))
                .produce(Pattern::op(Opcode::Ult, vec![Pattern::var("x"), Pattern::var("y")]))
                .build(),
        );
